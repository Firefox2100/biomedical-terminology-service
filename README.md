...
* Unified access to multiple biomedical vocabularies and ontologies, including SNOMED CT, CTV3, GO, HGNC, HPO, LOINC, MONDO, NCIt, OMIM, ORDO, Reactome, RxNorm, Ensembl, OHDSI, Uberon, and UniProt.
