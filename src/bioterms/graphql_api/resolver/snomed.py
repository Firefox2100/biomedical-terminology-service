...
@SNOMED_CONCEPT.field('pathsTo')
async def resolve_snomed_concept_paths_to(obj,
                                          info,
                                          target_prefix: str,
...
@SNOMED_QUERY.field('search')
async def resolve_snomed_search(_, info, query: str, limit: int = None) -> dict:
