...
ANNOTATION_NAME = 'Mondo Mapping to ORDO'
...
async def load_annotation_from_file(graph_db: GraphDatabase = None,
    ...
    """
    Load the Mondo to ORDO mapping from a file into the primary databases.
    ...
    raise NotImplementedError(
        'Mondo to ORDO mapping is part of the Mondo release, and should have been loaded during the Mondo import'
    )
