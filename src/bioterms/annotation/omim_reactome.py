...
ANNOTATION_NAME = 'Reactome ReferenceEntity Mapping to OMIM'
VOCABULARY_PREFIX_1 = ConceptPrefix.REACTOME
VOCABULARY_PREFIX_2 = ConceptPrefix.OMIM
FILE_PATHS = ['reactome/omim_mapping.csv']
...
async def load_annotation_from_file(graph_db: GraphDatabase = None):
    ...
    annotations = build_reference_annotations(ConceptPrefix.OMIM)
    verbose_print(f'Processed {len(annotations)} Reactome to OMIM annotations. Saving...')
