...
ANNOTATION_NAME = 'Mondo Mapping to SNOMED'
...
async def load_annotation_from_file(graph_db: GraphDatabase = None,
    ...
    """
    Load the Mondo to SNOMED mapping from a file into the primary databases.
    ...
    raise NotImplementedError(
        'Mondo to SNOMED mapping is part of the Mondo release, and should have been loaded during the Mondo import'
    )
