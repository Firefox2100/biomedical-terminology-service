"""UniProtKB-published protein associations to Orphanet disease records."""
...
from bioterms.vocabulary.uniprot import FILE_PATHS, download_vocabulary, iter_ordo_annotations


ANNOTATION_NAME = 'UniProtKB Mapping to ORDO'
...
async def load_annotation_from_file(graph_db: GraphDatabase = None):
    ...
    count = await save_annotation_stream(graph_db, iter_ordo_annotations())
    verbose_print(f'Loaded {count} UniProtKB to ORDO annotations.')
