...
ANNOTATION_NAME = 'Ohdsi Mapping to SNOMED'
...
async def download_annotation(download_client: httpx.AsyncClient = None):
    ...
    raise FilesNotFound(
        message='Ohdsi to SNOMED mapping file is part of the Ohdsi release, and cannot be downloaded separately',
    )
...
async def load_annotation_from_file(graph_db: GraphDatabase = None,
    ...
    """
    Load the Ohdsi to SNOMED mapping from a file into the primary databases.
    ...
    raise NotImplementedError(
        'Ohdsi to SNOMED mapping is part of the Ohdsi release, and should have been loaded during the Ohdsi import'
    )
