# Licence of SNOMED CT data

This project utilises the data from the SNOMED CT, provided by the NHS TRUD in the UK. However, this project is in no way affiliated with or endorsed by the NHS TRUD.
...
**SNOMED CT® UK NATIONAL RELEASE AFFILIATE LICENCE AGREEMENT**
...
License Fees and other conditions and restrictions apply to the use of the International Release of SNOMED CT in a Non-Member Territory, and to the deployment, distribution and licensing of Licensee Products within a Non-Member Territory. In this regard the Licensee’s attention is drawn in particular to **clause 7 (License Fees)** and c**lause 9 (Use in Member Territories and Non-Member Territories)**.
...
- [SNOMED CT International Edition](https://isd.digital.nhs.uk/trud/users/authenticated/filters/0/categories/4/items/4/releases)
- [SNOMED CT UK Clinical Edition](https://isd.digital.nhs.uk/trud/users/authenticated/filters/0/categories/26/items/101/releases)
- [SNOMED CT UK Drug Extension](https://isd.digital.nhs.uk/trud/users/authenticated/filters/0/categories/26/items/105/releases)
- [SNOMED CT Orphanet Map package](https://www.nlm.nih.gov/healthit/snomedct/international.html)
